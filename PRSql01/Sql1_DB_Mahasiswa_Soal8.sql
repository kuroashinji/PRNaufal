...
SELECT Mahasiswa .Kode_Mahasiswa ,Mahasiswa .Nama_Mahasiswa ,Jurusan .Nama_Jurusan ,Agama .Deskripsi ,Dosen .Nama_Dosen ,Jurusan .Status_Jurusan ,Type_Dosen .Deskripsi 
FROM ((((Mahasiswa 
